...
public class Feedback {
    ...
    public enum Column {
        ...
        memberId("member_id", "memberId", "BIGINT", true),
        feedbackType("feedback_type", "feedbackType", "INTEGER", true),
        title("title", "title", "VARCHAR", true),
        message("message", "message", "VARCHAR", true),
        pics("pics", "pics", "VARCHAR", true),
        status("status", "status", "INTEGER", true),
        reply("reply", "reply", "VARCHAR", true),
